...
tbl = table({results.cell_type}',R_array, fit_array,tau_array, tau_sd_array, ...
    ...
    spike_number', latency_to_first_spike', adaptaion_index', ISI_cv', block_current_level, max_slope_array,...
    ...
    'Spike_numbers', 'Latency_to_first_spike', 'Adaptation_index', 'ISI_cv', 'Blocked_current_level', 'Max_slope'})
